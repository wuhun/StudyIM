 ...
 * ================================================
 */
public class WuhunOpenFileTool {

    private static WuhunOpenFileTool instence;

    private Context context;

    private WuhunOpenFileTool(Context context) {
        this.context = context;
    }

    public static WuhunOpenFileTool getInstence(Context context) {
        if (instence == null) {
            synchronized (WuhunOpenFileTool.class) {
                if (instence == null) {
                    instence = new WuhunOpenFileTool(context);
                }
            }
        }
        return instence;
    ...
    public void openFiles(String filesPath) {
        ...
        if (isIntentAvailable(context, intent)) {
            ...
            WuhunToast.info("暂无可以查看的app").show();
        }
    }
